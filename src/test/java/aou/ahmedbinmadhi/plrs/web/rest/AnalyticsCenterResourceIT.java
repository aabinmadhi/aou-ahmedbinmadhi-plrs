...
class AnalyticsCenterResourceIT {
    ...
    void createAnalyticsCenter() throws Exception {
        ...
        restAnalyticsCenterMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(analyticsCenter))
            )
    ...
    void putExistingAnalyticsCenter() throws Exception {
        ...
        restAnalyticsCenterMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAnalyticsCenter.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedAnalyticsCenter))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAnalyticsCenter() throws Exception {
        ...
        restAnalyticsCenterMockMvc
            .perform(
                put(ENTITY_API_URL_ID, analyticsCenter.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(analyticsCenter))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAnalyticsCenter() throws Exception {
        ...
        restAnalyticsCenterMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(analyticsCenter))
            )
    ...
    void patchNonExistingAnalyticsCenter() throws Exception {
        ...
        restAnalyticsCenterMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, analyticsCenter.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(analyticsCenter))
            )
            .andExpect(status().isBadRequest());
