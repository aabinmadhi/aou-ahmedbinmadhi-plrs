...
class PlrsCommissionResourceIT {
    ...
    void createPlrsCommission() throws Exception {
        ...
        restPlrsCommissionMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(plrsCommission))
            )
    ...
    void putExistingPlrsCommission() throws Exception {
        ...
        restPlrsCommissionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedPlrsCommission.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedPlrsCommission))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingPlrsCommission() throws Exception {
        ...
        restPlrsCommissionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, plrsCommission.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(plrsCommission))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamPlrsCommission() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPlrsCommissionMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(plrsCommission)))
    ...
    void patchNonExistingPlrsCommission() throws Exception {
        ...
        restPlrsCommissionMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, plrsCommission.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(plrsCommission))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamPlrsCommission() throws Exception {
        ...
        restPlrsCommissionMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(plrsCommission))
            )
            .andExpect(status().isMethodNotAllowed());
