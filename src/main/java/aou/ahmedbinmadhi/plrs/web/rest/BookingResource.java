...
import aou.ahmedbinmadhi.plrs.service.BookingService;
...
public class BookingResource {
     ...
     */
    @GetMapping("/bookings")
    public List<BookingDTO> getAllBookings(@RequestParam(required = false) String filter) {
        if ("profit-is-null".equals(filter)) {
            log.debug("REST request to get all Bookings where profit is null");
            return bookingService.findAllWhereProfitIsNull();
        }
